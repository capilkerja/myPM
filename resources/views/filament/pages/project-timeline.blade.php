            ...
            <div class="w-full">
                ...
                @else
                    <div class="flex flex-col items-center justify-center h-64 text-gray-500 gap-4">
                        ...
                        <p class="text-sm">tambahkan tanggal mulai dan akhir proyek untuk melihat timeline</p>
                    </div>
                @endif
            </div>
        </x-filament::section>
        ...
        <x-filament::section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-gray-600 dark:text-gray-400">Melebihi Deadline</span>
                </div>
            </div>
        </x-filament::section>
    </div>
        ...
        <script>
            ...
            function initializeGanttPage() {
                try {
                    ...
                    if (!ganttPageInitialized) {
                        // gantt.i18n.setLocale("id"); // aktifkan locale Indonesia

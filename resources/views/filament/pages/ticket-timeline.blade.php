    ...
    <div class="space-y-6">
                ...
                <div class="w-full">
                    ...
                    @else
                        <div class="flex flex-col items-center justify-center h-64 text-gray-500 gap-4">
                            ...
                            <h3 class="text-lg font-medium">Tidak ada ticket</h3>
                            <p class="text-sm">Tambahkan Deadline ke tiket untuk melihat timeline.</p>
                        </div>
                    @endif
                </div>
            </div>
        @else
            <div class="flex flex-col items-center justify-center h-64 text-gray-500 gap-4">
                ...
                <h2 class="text-xl font-medium">Pilih Project</h2>
                <p class="text-sm">Pilih project terlebih dahulu untuk melihat timeline.</p>
            </div>
        @endif
    </div>
